...
public class AppManager extends AppOpenAd.AppOpenAdLoadCallback implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    private AppManager(Builder builder) {
...
//        Do nothing
    ...
    public void onApplicationBecameActive() {
        if (this.showAdAutomatically) {
            ...
            if (!"ui.activity.SplshActivity".equals(mostCurrentActivity.getLocalClassName())) {
                showAdIfAvailable();
            }

        }
        Log.d(TAG, ""+mostCurrentActivity.getLocalClassName());
